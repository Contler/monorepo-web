...
export class MetricsComponent implements OnInit {
  ...
  getMetric(id: number) {
    switch (id) {
      ...
      case 5:
        this.metricService
          .getMetric('average-score', this.hotelId, this.since, this.until)
          .subscribe(this.downloadFile);
        break;
      case 6:
        this.metricService
      ...
      case 7:
        this.metricService
          .getMetric('active-rooms', this.hotelId, this.since, this.until)
          .subscribe(this.downloadFile);
        break;
      case 8:
        this.metricService
      ...
      case 9:
        this.metricService
          .getMetric('active-user', this.hotelId, this.since, this.until)
          .subscribe(this.downloadFile);
        break;
      case 10:
        this.metricService
          .getMetric('get-gain-restaurant', this.hotelId, this.since, this.until)
          .subscribe(this.downloadFile);
        break;
      case 11:
        this.metricService
          .getMetric('active-employer', this.hotelId, this.since, this.until)
          .subscribe(this.downloadFile);
        break;
      default:
        break;
